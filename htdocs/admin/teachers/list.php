...
if (!empty($search)) {
    $sql .= " AND (name LIKE :search OR card_id LIKE :search OR number LIKE :search)";
...
<div class="list-container">
    <div class="list-card">
        <div class="list-header">
            <h2>
                <i class="fas fa-chalkboard-teacher"></i> শিক্ষক তালিকা
                <span class="count">(মোট: <?php echo count($teachers); ?>)</span>
            </h2>
        ...
        <form method="GET" class="filter-form">
            <input type="text" name="search" placeholder="🔍 নাম, কার্ড আইডি বা মোবাইল..." value="<?php echo htmlspecialchars($search); ?>">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php else: ?>
                                <span class="status-badge status-resigned">📤 অবসরপ্রাপ্ত</span>
                            <?php endif; ?>
                        </td>
                        <td>
        ...
        <div class="empty-state">
            ...
            <a href="add.php" class="btn-add" style="display:inline-block;margin-top:12px;">নতুন শিক্ষক যোগ করুন</a>
        </div>
        <?php endif; ?>
    </div>
</div>
